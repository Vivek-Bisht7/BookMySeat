...
const Navbar = () => {
  ...
  return (
    <div className="bg-neutral-900 h-12 w-full flex items-center px-4 border-b border-neutral-800 select-none">
      {/* Left */}
      ...
      {/* Center */}
      {isAdminRoute ? (
        <h2 className="flex-1 text-center text-xl font-semibold text-white">
